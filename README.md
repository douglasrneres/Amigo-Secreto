Este é o PROJETO AMIGO SECRETO, uma aplicação simples em JavaScript para adicionar nomes a uma lista e sortear aleatoriamente um amigo entre os cadastrados previamente.
